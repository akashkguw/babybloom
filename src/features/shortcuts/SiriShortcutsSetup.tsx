...
export default function SiriShortcutsSetup({ volumeUnit }: SiriShortcutsSetupProps) {
  ...
  const shortcuts = [
    { name: 'Baby Nurse Left', icon: '🤱', param: 'quick=breast_l', desc: 'Log left side nursing' },
    { name: 'Baby Nurse Right', icon: '🤱', param: 'quick=breast_r', desc: 'Log right side nursing' },
    ...
    { name: 'Baby Pee', icon: '💧', param: 'quick=wet', desc: 'Log pee diaper' },
    { name: 'Baby Poop', icon: '💩', param: 'quick=dirty', desc: 'Log poop diaper' },
      ...
      {show && (
        ...
        >
          ...
          <div style={{ fontSize: 12, color: C.t, lineHeight: 1.7, marginBottom: 14 }}>
            ...
            <br />
            <br />
            Say <strong>"Hey Siri, Baby Nurse Left"</strong> to use it hands-free.
          </div>
